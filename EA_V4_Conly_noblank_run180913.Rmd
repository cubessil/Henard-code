...
data[ data$Analysis == 15234 , "Identifier1"] <- "HOS"
data[ data$Analysis == 15234 , "mass"] <- "409"
data[ data$Analysis == 15234 , "carousel"] <- "26"
data[ data$Analysis == 15234 , "type"] <- "mon.std"
