...
stds.to.cull <- c(16228) #Analysis with yield problem and/or significant outlier in d13C or d18O, can rerun this line after 1st round to see outiers, than add them here   
...
```{r}
iso_plot_continuous_flow_data(dxf_files$`16200__empty_0.dxf`  , c(44,45,46)) #what happend? left from last run?
```
```{r}
